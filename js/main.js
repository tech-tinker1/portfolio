...
document.getElementById('openLinkedInButton').addEventListener('click', function() {
    var link = document.createElement('a');
    link.href = 'https://linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=kubaib-borkala-4ba891321';  // Replace with your LinkedIn URL
    link.target = '_blank';  // This opens the link in a new tab
    link.click();
});

document.getElementById('openInstaButton').addEventListener('click', function() {
    var link = document.createElement('a');
    link.href = 'https://www.instagram.com/kubaib__?igsh=bjV5c2hrb3A2ajJv';  // Replace with your LinkedIn URL
    link.target = '_blank';  // This opens the link in a new tab
    link.click();
});
